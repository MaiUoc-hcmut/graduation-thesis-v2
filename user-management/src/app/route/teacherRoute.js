...
router.route('/get-profile-teacher/:teacherId').get(TeacherController.getProfileTeacher);
...
router.route('/filter/page/:page').get(TeacherController.getFilteredTeacher);
