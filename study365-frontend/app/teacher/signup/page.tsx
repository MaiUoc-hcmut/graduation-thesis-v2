...
export default function Signup() {
    return (
        <div className="m-auto w-3/4 mt-10 mb-20">
            <form>
                ...
                <div className="mt-6 flex items-center justify-end gap-x-6">
                    <button type="button" className="rounded-md bg-input_primary px-3 py-2 text-sm font-semibold leading-6 text-gray-900">
                        Cancel
                    </button>
                    <button
                        type="submit"
