                ...
                <div className="flex flex-wrap justify-between items-center">
                    ...
                    <div className="flex items-center lg:order-2">
                        ...
                        <div className='w-32 mr96 flex items-center justify-start' data-dropdown-toggle="dropdown">
                            ...
                            <div className='ml-2'>Việt Lê</div>
                        </div>
                        {/* Dropdown menu */}
                        <div
                        ...
                        >
                            ...
                            >
                                <li>
                                    <Link
                                        href="#"
                                        className="block py-2 px-4 text-sm text-[#f63c3c] hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                    >
                                        Đăng xuất
                                    </Link>
                                </li>
