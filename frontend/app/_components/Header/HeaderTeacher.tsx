                                        ...
                                        <div className="divide-y divide-gray-100 dark:divide-gray-700">
                                            ...
                                            >
                                                ...
                                                <div className="w-full px-3">
                                                    ...
                                                    <div className="text-gray-500 text-sm mb-1.5 dark:text-gray-400 whitespace-nowrap text-ellipsis overflow-hidden mr-5">
                                                        Hey, whats up? All set for the presentation?Hey, whats up? All set for the presentation?
                                                    </div>
