...
import CustomTinyMceEditor from '@/app/_components/Editor/TinyMceEditor'
        ...
        async function fetchData() {
            if (topicId != '') {
                if (topic?.type == "lecture")
                    ...
                    await examApi.getAssigmnentByExamId(`${user.id}`, '1').then((data) => {
                        ...
                        <div className='p-4 flex-1 ' >
                            <div className='bg-white rounded-[10px] p-4 '>
                                <section className='flex justify-between items-center border-[1px] border-[#ececec] p-3 rounded-lg'>
                                    ...
                                    <div className='h-1/2'>
                                        <Link href={`/course/learning/${params.slug}/exam/attemp/${topic.id}}`} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Làm bài</Link>
                                    </div>
                                            ...
                                            <div className='flex'>
                                                ...
                                                <div className='flex-1 mr-4'>
                                                    <form onSubmit={async (e) => {
                                                        ...
                                                        <div className={`${toggle[`edit-cmt`] ? '' : 'hidden'}`}>
                                                            <CustomTinyMceEditor value={content} setValue={setContent} />
                                                        </div>
