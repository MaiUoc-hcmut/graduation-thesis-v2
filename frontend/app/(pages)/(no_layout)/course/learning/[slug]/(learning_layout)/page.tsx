                                                        ...
                                                        <div>
                                                            {
                                                                chapter.topics.map((topic: any) => {
                                                                    if (topic.type == "exam") {
                                                                        return (
                                                                            <Link href={`/course/learning/${params.slug}/exam/${topic.id}`} key={topic.id} className={`${topicId == topic.id ? 'bg-[#f1f1f1]' : 'bg-white'} px-2 py-2 mb-1 cursor-pointer flex items-center`}>
